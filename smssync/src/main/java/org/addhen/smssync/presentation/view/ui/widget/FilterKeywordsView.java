    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mKeywordTextColor = attributesArray
                    .getColor(R.styleable.FilterKeywords_filterKeywordTextColor,
                            getResources().getColor(mKeywordTextColor));
            mKeywordCounterTextColor = attributesArray
                    .getColor(R.styleable.FilterKeywords_filterKeywordCounterTextColor,
                            getResources().getColor(mKeywordCounterTextColor));
            mKeywordTextSize = attributesArray
                    .getDimension(R.styleable.FilterKeywords_filterKeywordTextSize,
                            DEFAULT_TEXT_SIZE);
